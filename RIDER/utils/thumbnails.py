...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"RIDER/assets/RIDER.png")
        ...
        font = ImageFont.truetype("RIDER/assets/font2.ttf", 45)
        ImageFont.truetype("RIDER/assets/font2.ttf", 70)
        arial = ImageFont.truetype("RIDER/assets/font2.ttf", 30)
        ImageFont.truetype("RIDER/assets/font.ttf", 30)
