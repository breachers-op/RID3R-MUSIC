...
from RIDER.utils import (Vipbin, get_channeplayCB,
                              seconds_to_min)
from RIDER.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from RIDER.utils.decorators.language import language, languageCB
from RIDER.utils.inline import queue_back_markup, queue_markup
