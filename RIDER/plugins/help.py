...
from RIDER.utils import help_pannel
from RIDER.utils.database import get_lang, is_commanddelete_on
from RIDER.utils.decorators.language import (LanguageStart,
                                                  languageCB)
from RIDER.utils.inline.help import (help_back_markup,
                                          private_help_panel)
    ...
    if cb == "hb9":
        if CallbackQuery.from_user.id not in SUDOERS:
            return await CallbackQuery.answer(
                   "😎𝗣𝗔𝗛𝗟𝗘 𓆩𝗥𝗜𝗗𝗘𝗥𓆪 𝗞𝗢 𝗣𝗔𝗣𝗔 𝗕𝗢𝗟 𝗝𝗔𝗞𝗘 😆😆", show_alert=True
            )
        else:
