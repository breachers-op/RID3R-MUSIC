...
async def init():
    ...
    for all_module in ALL_MODULES:
        importlib.import_module("RIDER.plugins" + all_module)
    LOGGER("RIDER.plugins").info(
    ...
    LOGGER("RIDER").info("╔═════ஜ۩۞۩ஜ════╗\n  ♨️𝗠𝗔𝗗𝗘 𝗕𝗬 𝗞𝗡𝗜𝗚𝗛𝗧 𝗥𝗜𝗗𝗘𝗥♨️\n╚═════ஜ۩۞۩ஜ════╝")
    await idle()


if __name__ == "__main__":
    loop.run_until_complete(init())
    LOGGER("RIDER").info("Stopping Music Bot...")
